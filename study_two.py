...
def dist_gen():
    ...
    plt.hist(c_I, bins=np.arange(-50, 2, 2), weights=weights_c, edgecolor="black", color="teal")
    print("TASK cI")
...
def data(c_I, d_I):
    ...
    plt.figure(figsize=(9, 7))
    plt.hist(I_B2, bins=bins, label="I_B2", weights=weights_B2, edgecolor="black", color="teal")
...
def I_ib_gen(I_B1, I_B2):
    ...
    plt.figure(figsize=(9, 7))
    plt.hist(I_ib, bins=bins_ib, weights=weights_ib, edgecolor="black", color="teal")
    ...
    plt.figure(figsize=(9, 7))
    plt.hist(I_io, bins=bins_io, weights=weights_io, edgecolor="black", color="teal")
