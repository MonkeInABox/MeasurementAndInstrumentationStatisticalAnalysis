...
def data():
    ...
    ___, bins, ___ = plt.hist(dataset, bins='stone')
    plt.xticks(bins)
...
def sort(dataset):
    ...
    print("typical = " + str(2 * np.std(dataset)))
    print("MINMAX = " + str(4 * np.std(dataset)))
    ___, bins, ___ = plt.hist(dataset, bins=1 + int(np.log2(len(dataset))), edgecolor = "black")
    plt.xticks(bins)
    ...
    ___, bins, ___ = plt.hist(negative_ds, bins=1 + int(np.log2(len(dataset))), edgecolor = "black")
    plt.xticks(bins)
